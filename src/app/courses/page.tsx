      ...
      <section className="py-16 md:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          {filteredCourses.length === 0 ? (
            <div className="p-12 rounded-3xl bg-stone-900/60 border border-stone-800 text-center space-y-5 max-w-2xl mx-auto">
              <div className="w-16 h-16 rounded-full bg-[#2c4939]/60 text-[#a5c6af] border border-[#558d6e]/40 flex items-center justify-center mx-auto shadow-inner">
              ...
              <div className="space-y-2">
                <h3 className="font-serif-luxury text-2xl font-bold text-white">
                  {searchQuery || selectedCategory !== "all"
                    ...
                    : "Masterclasses & Video Courses Library"}
                </h3>
                <p className="text-xs sm:text-sm text-[var(--text-muted)] leading-relaxed">
                  {searchQuery || selectedCategory !== "all"
                    ? "Try clearing your search query or selecting 'All Masterclasses'."
                    : "No public video courses are currently active. Clinical masterclass video modules will be uploaded soon!"}
                </p>
              </div>
              ...
              <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
                {searchQuery || selectedCategory !== "all" ? (
                  <button
                    ...
                    className="px-5 py-2.5 rounded-full text-xs font-bold bg-[#558d6e] hover:bg-[#427256] text-white transition-all cursor-pointer shadow-md"
                  >
                    Clear Filters
                  </button>
                ) : (
                  <>
                    <button
                      onClick={handleOpenAdminStudio}
                      className="px-5 py-2.5 rounded-full text-xs font-bold bg-[#558d6e] hover:bg-[#427256] text-white transition-all cursor-pointer shadow-md flex items-center gap-2"
                    >
                      <Lock className="w-3.5 h-3.5 text-amber-300" />
                      <span>Admin: Create New Course / Upload Video</span>
                    </button>
                    <Link
                      href="/"
                      className="px-4 py-2.5 rounded-full text-xs font-semibold bg-stone-800 hover:bg-stone-700 text-stone-300 transition-all cursor-pointer"
                    >
                      Back to Home
                    </Link>
                  </>
                    ...
                    {hasLessons ? (
                      ...
                      <div className="p-6 rounded-2xl bg-stone-950/60 border border-stone-800/80 text-center space-y-2">
                        ...
                        <p className="text-[11px] text-stone-500 max-w-md mx-auto">
                          Clinical masterclass video lectures are uploaded directly via the password-protected Admin Studio.
                        </p>
                      </div>
                    )}
                  </div>
