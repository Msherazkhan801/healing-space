  ...
  const handleAddVideoLesson = async (e: React.FormEvent) => {
    ...
    try {
      const updated = await addGoogleDriveLessonToCourse(selectedCourseId, {
        ...
        description: newLessonDesc || "Guided psychological masterclass lecture by Dr. Maheen.",
  ...
  const handleCreateNewCourse = async (e: React.FormEvent) => {
    ...
    try {
      const updated = await createCourse({
        ...
        tagline: newCourseTagline || "Clinical Masterclass by Dr. Maheen",
        category: newCourseCategory,
        level: "Beginner Friendly",
        totalDuration: "Self-Paced",
        badge: "New Masterclass",
        thumbnail: "/images/nature.jpg",
        description: newCourseDesc || "Comprehensive psychological masterclass modules by Dr. Maheen.",
        instructor: {
          name: "Dr. Maheen",
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[var(--text-muted)]">
                {isAuthenticated
                  ? "Logged in as Dr. Maheen (Administrator)"
        ...
        {!isAuthenticated ? (
          <div className="py-12 flex flex-col items-center justify-center text-center max-w-md mx-auto space-y-6">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-[var(--text-muted)]">
                Only Dr. Maheen and authorized practice administrators can manage patient appointments and upload Google Drive masterclass videos.
              </p>
            </div>
                ...
                {selectedCourse && (
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      >
                        <span>Preview on Public Courses Page</span>
                    ...
                    {selectedCourse.lessons.length === 0 ? (
                      <div className="p-8 rounded-2xl bg-stone-950 border border-stone-800 text-center space-y-2">
                        ...
                        <p className="text-xs text-stone-400">
                          No videos in this course yet. Paste your first Google Drive share link above!
                        </p>
                      </div>
                    ) : (
                          ...
                          >
                            ...
                            <div className="flex items-center gap-2 shrink-0">
                              ...
                              <button
                                ...
                                className="p-1.5 rounded-lg bg-rose-950/60 border border-rose-900 text-rose-400 hover:bg-rose-900 hover:text-white transition-all cursor-pointer"
